...
public class TestData {
	...
	String company_name, contact_person, emailID, password, business_description, industry_caters, primary_expertise,
			secondary_expertise, website, year_of_incorporation, status_of_product, last_yr_revenue,last_yr_revenue_currency,
			current_monthy_rate,current_monthy_rate_currency, register_address, city, state, country, contact_prefix, contact_sufix, founder_tag,
			employees,pincode, LoginURL = "http://staging.zoom12.com/#/",
